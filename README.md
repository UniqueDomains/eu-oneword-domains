# Available .EU One-Word Domains (8,903)
...
> The full live catalog for this exact search currently contains **8,903 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 8,903 domains · **Median ask:** $434.42 · **High-demand under $2,500:** 3
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 8,903 live domains                         |
...
> Unique Domains. *Available .EU One-Word Domains*. Version 2026-08-23. Public GitHub extract for the exact Unique Domains search represented by this repository.
