# Available .EU One-Word Domains (9,761)
...
> The full live catalog for this exact search currently contains **9,761 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 9,761 domains · **Median ask:** $406.02 · **High-demand under $2,500:** 4
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 9,761 live domains                         |
...
> Unique Domains. *Available .EU One-Word Domains*. Version 2026-09-05. Public GitHub extract for the exact Unique Domains search represented by this repository.
