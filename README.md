# Available .EU One-Word Domains (7,665)
...
> The full live catalog for this exact search currently contains **7,665 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 7,665 domains · **Median ask:** $484.39 · **High-demand under $2,500:** 3
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 7,665 live domains                         |
...
> Unique Domains. *Available .EU One-Word Domains*. Version 2026-08-18. Public GitHub extract for the exact Unique Domains search represented by this repository.
